...
const siteConfig = {
  ...
  projectName: 'react-isomorphic-data',
  organizationName: 'jackyef',
  ...
  */
  ...
  copyright: `Copyright © ${new Date().getFullYear()} Jacky Efendi`,
  ...
  repoUrl: 'https://github.com/jackyef/react-isomorphic-data',
  twitterUsername: 'jacky_efendi',
};
